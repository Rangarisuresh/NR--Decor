...
$processing_time_days = 2; // Processing time in days
$shipping_time_days = 5; // Shipping time in days
$estimated_delivery_date = date('F j, Y', strtotime("+" . ($processing_time_days + $shipping_time_days) . " days"));
			...
			<tr>
                <td>
                    <div class="estimated-delivery">
                        <h4>Estimated Delivery Date: <?php echo $estimated_delivery_date; ?></h4>
                    </div>
                </td>
            </tr>
		</thead><!-- /thead -->
